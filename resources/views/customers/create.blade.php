                ...
                <div style="margin-left: 15px;margin-right: 15px;margin-bottom: 50px" class="panel panel-flat">
                    <div class="panel-body">
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Tên khách hàng:<span style="color: red">*</span></label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Email:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Số điện thoại:<span style="color: red">*</span></label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Phân loại:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Tuổi:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Nghề nghiệp:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Địa chỉ:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Giới tính:</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label style="width: 16%;" class="col-lg-2 control-label">Nhân viên hỗ trợ:<span
